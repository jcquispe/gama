            ...
            <div class="col-sm-8">
                <div class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <h4><strong>{{ Auth::user()->nombre }}</strong></h4>
                        </div>
                    </div>
                    
                    <div class="form-group">
                        {!!Form::label('paterno', 'Apellido Paterno:', ['class'=>'col-sm-3 control-label'])!!}
                        <div class="col-sm-9">
                            <h4><strong>{{ Auth::user()->paterno }}</strong></h4>
                        </div>
                    </div>
                    
                    <div class="form-group">
                        {!!Form::label('materno', 'Apellido Materno:', ['class'=>'col-sm-3 control-label'])!!}
                        <div class="col-sm-9">
                            <h4><strong>{{ Auth::user()->materno }}</strong></h4>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <h4><strong>{{ Auth::user()->ci }} {{ Auth::user()->exp }}</strong></h4>
                        </div>
                    </div>
